...
os.makedirs("./pps_data", exist_ok=True)

csv_file = open("./pps_data/pps_log.csv", mode='w', newline='')
...
def cleanup(signum=None, frame=None):
    ...
    csv_file.close()
    print("Données enregistrées dans './pps_data/pps_log.csv'")
    sys.exit(0)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Mesure PPS avec XDP")
